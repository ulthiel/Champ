...
intrinsic CalogeroMoserFamilies(H::AlgChe : UseDB:=true) -> SetEnum
{}

	CalogeroMoserFamilies(~H: UseDB:=UseDB);
	return H`CalogeroMoserFamilies;

end intrinsic;

intrinsic CalogeroMoserHyperplanes(H::AlgChe : UseDB:=true) -> SetEnum
{}
